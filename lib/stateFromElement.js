...
var _replaceTextWithMeta3 = _interopRequireDefault(require("./lib/replaceTextWithMeta"));
...
var _styleToCssString = _interopRequireDefault(require("./styleToCssString"));
...
var ContentGenerator = /*#__PURE__*/function () {
  ...
  function ContentGenerator() {
    ...
    _defineProperty(this, "elementStyles", void 0);

    _defineProperty(this, "customStyleMap", void 0);
    ...
    this.contentStateForEntities = _draftJs.ContentState.createFromBlockArray([]); // This represents the hierarchy as we traverse nested elements; for
  ...
  _createClass(ContentGenerator, [{
    ...
    value: function processBlockElement(element) {
      ...
      if (type === _draftJsUtils.BLOCK_TYPE.CODE) {
    ...
    value: function processInlineElement(element) {
      ...
      if (styleAttribute) {
        ...
        Object.keys(this.customStyleMap).forEach(function (key) {
          customCssMapToStyle[normalizeStyle((0, _styleToCssString["default"])(_this2.customStyleMap[key]))] = key;
        });

        var _iterator = _createForOfIteratorHelper(styleAttribute.split(';')),
            _step;
...
function collapseWhiteSpace(text, characterMeta) {
  ...
  var _replaceTextWithMeta = (0, _replaceTextWithMeta3["default"])({
    text: text,
    characterMeta: characterMeta
  ...
  var _replaceTextWithMeta2 = (0, _replaceTextWithMeta3["default"])({
    text: text,
    characterMeta: characterMeta
  }, ' ' + SOFT_BREAK_PLACEHOLDER, SOFT_BREAK_PLACEHOLDER);
